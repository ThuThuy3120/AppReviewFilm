...
class MovieBoundaryCallback (
    ...
    override fun onZeroItemsLoaded() { //Được gọi khi không có mục nào được trả về từ lần tải
        // ban đầu của nguồn dữ liệu của PagedList.
    ...
    override fun onItemAtEndLoaded(itemAtEnd: Movie) {//Được gọi khi mục ở cuối PagedList đã được tải
        // và quyền truy cập đã xảy ra trong prefetchDistance đó.
