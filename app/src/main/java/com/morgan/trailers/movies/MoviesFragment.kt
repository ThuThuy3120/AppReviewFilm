...
class MoviesFragment : Fragment() {
    ...
    override fun onCreateView(  //thiết lập về giao diện
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) { //thay đổi giao diện hay các tương tác với Activity chứa Fragment
