...
class MovieAdapter(private val moviesViewModel: MoviesViewModel): PagedListAdapter<Movie,MovieAdapter.ViewHolder>(MovieDiffCallback){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder { //tạo view mới cho RecyclerView
        return ViewHolder.fromParent(parent)
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {//gắn data và ánh xạ view.
